...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    shell: {
        campaign_styleguide: {
            command: '../../node_modules/kss/bin/kss-node --source themes/custom/campaign_base/sass/ --destination themes/custom/campaign_base/styleguide --css ../css/styles.css --template themes/custom/campaign_base/kss/ --verbose'
        },
        rnd17_styleguide: {
