Feature: Landing-page
  ...
  Scenario: Create landing page with associated paragraphs
    ...
    And I am viewing a "landing" content with "Test landing page" title and "http://dummyimage.com/600x16:9" image and "<h1>Behat or Liv?</h1><h2>Spot the five differences!</h2>" body and with the following paragraphs:
      ...
      | cr_rich_text_paragraph | | files/400x16:9.png | <h2>Rich text bg title</h2> <p>Rich text paragraph body </p> | | | | |
      | single_msg | Single Message 1 | files/400x16:9.png | SMR 1 with cream grey background | | bg--gainsboro-grey | 0 | 0 |
      | single_msg | Single Message 2 | files/400x16:9.png | SMR 2 with white background | | bg--white | 1 | 1 |
    # And I break
