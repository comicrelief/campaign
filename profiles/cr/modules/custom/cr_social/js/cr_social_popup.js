...
(function ($) {
  ...
  Drupal.behaviors.crSocialPopup = {
    ...
    attach: function (context, settings) {
      ...
      var _base = Drupal.behaviors.crSocialPopup;
      var _settings = _base.settings;

      $('.social-link-popup').once('crSocialPopup').each(function () {
        $(this).addClass("crSocialPopup-processed");
      });
