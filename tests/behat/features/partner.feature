Feature: Partner
  ...
  Scenario: Create a new partner
    ...
    | field_partner_logo | ../tests/behat/files/400x4:3.png |
    | field_partner_website | Link - http://www.better.co.uk |
    | field_partner_image | ../tests/behat/files/400x4:3.png, ../tests/behat/files/400x4:3.png, ../tests/behat/files/400x4:3.png |
